...
def region_of_interest(image,vertices):
    ...
    masked_image=cv2.bitwise_and(image,mask)#maskı kullanır hale getirir
...
def process(image):
    ...
    canny_image=cv2.Canny(gray_image,250,120)#çizgi belirlemek için kullanılan fonk
...
cap=cv2.VideoCapture("videooo1.mp4")
